    ...
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          ...
          <div>
            <h1 className="brand-title">3-Tier App</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to React-Node-MySql 3-Tier App 🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} 3-Tier App. All rights reserved.</p>
      </footer>
